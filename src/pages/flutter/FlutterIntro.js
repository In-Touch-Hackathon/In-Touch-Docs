...
In Touch Flutter App is written in [Flutter](https://flutter.dev/) with dart. This is a ready-to-use app 
with the backend for connecting callers with volunteers. This app is not required to run In Touch, 
